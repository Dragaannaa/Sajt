...
function myFunction() {
  ...
  <hr> 
<div class="d-flex tekst">
@foreach ($korisnici as $korisnik)         
                        {{-- Insert komponente sa slanjem podataka komponenti
                        <x-klijenti :users="$users" /> --}}
                        <div  class="p-4 bd-highlight bg-light border border-white " >
                         
                          <h3 class="kvadrat">Korisnik biblioteke<h3><hr>
                            <p class="kvadrat">Naziv: {{ $korisnik ->name }}</p>
                            <p class="kvadrat">Mail: {{ $korisnik ->email }}</p>
                            <p class="kvadrat">Telefon: {{ $korisnik ->telephone }}</p>
                            <p class="kvadrat">Knjiga: {{ $korisnik ->comment }}</p>
